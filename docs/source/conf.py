...
project = "pyrolite_meltsutil"
copyright = "2019-%s, Morgan Williams" % date.today().year
...
html_context = {
    ...
    "github_repo": "pyrolite_meltsutil",  # Repo name
...
htmlhelp_basename = "pyrolite_meltsutildoc"
...
man_pages = [
    (master_doc, "pyrolite_meltsutil", "pyrolite-meltsutil Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        master_doc,
        "pyrolite_meltsutil",
        "pyrolite_meltsutil Documentation",
        author,
        "pyrolite_meltsutil",
        "pyrolite extension for working with alphaMELTS and its outputs.",
        "Science/Research",
    )
]
